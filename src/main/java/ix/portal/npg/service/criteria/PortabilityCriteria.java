 ...
 */
public class PortabilityCriteria implements Serializable, Criteria {
    ...
    public PortabilityCriteria() {}

    public PortabilityCriteria(PortabilityCriteria other) {
    ...
    @Override
    public PortabilityCriteria copy() {
        return new PortabilityCriteria(this);
    }
    ...
    public LocalDateTimeFilter getPorCrDate() {
        if (porCrDatePlain != null && porCrDatePlain.getEquals() != null) {
            porCrDate().setEquals(LocalDateTime.parse(porCrDatePlain.getEquals(), formatter));
        } else if (porCrDatePlain != null && porCrDatePlain.getNotEquals() != null) {
            porCrDate().setNotEquals(LocalDateTime.parse(porCrDatePlain.getNotEquals(), formatter));
        }
        return porCrDate;
    }
    ...
    public boolean equals(Object o) {
        ...
        final PortabilityCriteria that = (PortabilityCriteria) o;
        return (
