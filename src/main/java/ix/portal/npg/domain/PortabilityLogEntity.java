...
/**
 * A PortabilityLogEntity.
 */
@Entity
@Table(name = "TBL_PORTABILITY_LOG")
@Cache(usage = CacheConcurrencyStrategy.READ_WRITE)
public class PortabilityLogEntity implements Serializable {

    private static final long serialVersionUID = 1L;

    @Id
    @SequenceGenerator(name = "SEQ_NPG_PORT_LOG_ID_GENERATOR", sequenceName = "SEQ_NPG_PORT_LOG_ID", allocationSize = 0)
    @GeneratedValue(generator = "SEQ_NPG_PORT_LOG_ID_GENERATOR")
    private Long id;
    ...
    @Size(max = 26)
    @Column(name = "por_request_id", length = 26)
    ...
    @Size(max = 20)
    @Column(name = "por_id_number", length = 20)
    private String porIdNumber;

    @Size(max = 20)
    @Column(name = "por_contact_number", length = 20)
    ...
    @Size(max = 500)
    @Column(name = "por_rsp_note", length = 500)
    private String porRspNote;

    @Size(max = 500)
    @Column(name = "por_cancel_note", length = 500)
    private String porCancelNote;

    @Size(max = 26)
    @Column(name = "por_mnpid", length = 26)
    ...
    @Size(max = 255)
    @Column(name = "por_err_code", length = 255)
    private String porErrCode;

    @Size(max = 4000)
    @Column(name = "por_err_message", length = 4000)
    ...
    @Size(max = 500)
    @Column(name = "por_note", length = 500)
    ...
    @Size(max = 200)
    @Column(name = "intermediary_action_state", length = 200)
    ...
    public PortabilityLogEntity id(Long id) {
        this.id = id;
        return this;
    }
    ...
    public PortabilityLogEntity porId(Long porId) {
        this.porId = porId;
        return this;
    }
    ...
    public PortabilityLogEntity porRequestId(String porRequestId) {
    ...
    public PortabilityLogEntity porNumber(String porNumber) {
    ...
    public PortabilityLogEntity porLegalTerm(Integer porLegalTerm) {
    ...
    public PortabilityLogEntity porOpr(String porOpr) {
        this.porOpr = porOpr;
        return this;
    }
    ...
    public PortabilityLogEntity porAccType(String porAccType) {
    ...
    public PortabilityLogEntity porIdNumber(String porIdNumber) {
    ...
    public PortabilityLogEntity porContactNumber(String porContactNumber) {
    ...
    public PortabilityLogEntity porStatus(String porStatus) {
    ...
    public PortabilityLogEntity porPortedDate(LocalDateTime porPortedDate) {
    ...
    public PortabilityLogEntity porRouting(String porRouting) {
    ...
    public PortabilityLogEntity porType(String porType) {
    ...
    public PortabilityLogEntity porOpOrg(String porOpOrg) {
    ...
    public PortabilityLogEntity porRspCode(String porRspCode) {
    ...
    public PortabilityLogEntity porRspNote(String porRspNote) {
    ...
    public PortabilityLogEntity porCancelNote(String porCancelNote) {
    ...
    public PortabilityLogEntity porMnpid(String porMnpid) {
    ...
    public PortabilityLogEntity portationDate(LocalDateTime portationDate) {
    ...
    public PortabilityLogEntity portaCode(String portaCode) {
    ...
    public PortabilityLogEntity mvno(String mvno) {
        this.mvno = mvno;
        return this;
    }
    ...
    public PortabilityLogEntity context(String context) {
    ...
    public PortabilityLogEntity porErrCode(String porErrCode) {
    ...
    public PortabilityLogEntity porErrMessage(String porErrMessage) {
    ...
    public PortabilityLogEntity porOpd(String porOpd) {
        this.porOpd = porOpd;
        return this;
    }
    ...
    public PortabilityLogEntity porNumType(String porNumType) {
    ...
    public PortabilityLogEntity porNote(String porNote) {
    ...
    public PortabilityLogEntity porDeadline(LocalDateTime porDeadline) {
    ...
    public PortabilityLogEntity porResponseTimestamp(Long porResponseTimestamp) {
    ...
    public PortabilityLogEntity porEligible(Integer porEligible) {
    ...
    public PortabilityLogEntity porBillingOk(Integer porBillingOk) {
    ...
    public PortabilityLogEntity intermediaryActionState(String intermediaryActionState) {
    ...
    public PortabilityLogEntity porCrDate(LocalDateTime porCrDate) {
    ...
    public PortabilityLogEntity porUpdDate(LocalDateTime porUpdDate) {
    ...
    public PortabilityLogEntity porTechStatus(String porTechStatus) {
    ...
    public PortabilityLogEntity porTechDeadline(LocalDateTime porTechDeadline) {
    ...
    public PortabilityLogEntity refPorId(Long refPorId) {
    ...
    public PortabilityLogEntity needManualRetry(Integer needManualRetry) {
    ...
    public PortabilityLogEntity retryCount(Integer retryCount) {
    ...
    public PortabilityLogEntity action(String action) {
        this.action = action;
        return this;
    }
    ...
    public PortabilityLogEntity request(String request) {
    ...
    public PortabilityLogEntity insertTimestamp(LocalDateTime insertTimestamp) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof PortabilityLogEntity)) {
            return false;
        }
        return id != null && id.equals(((PortabilityLogEntity) o).id);
    }
