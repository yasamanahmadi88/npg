...
describe('Component Tests', () => {
  describe('SettingsComponent', () => {
    ...
    let mockTranslateService: { currentLang: string; use: jest.Mock };
    ...
    beforeEach(
      waitForAsync(() => {
        mockTranslateService = { currentLang: 'en', use: jest.fn() };
        TestBed.configureTestingModule({
          imports: [HttpClientTestingModule],
          declarations: [SettingsComponent],
          providers: [FormBuilder, { provide: TranslateService, useValue: mockTranslateService }, AccountService],
        })
