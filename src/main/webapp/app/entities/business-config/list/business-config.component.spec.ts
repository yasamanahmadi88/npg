...
describe('Component Tests', () => {
  describe('BusinessConfig Management Component', () => {
    let comp: BusinessConfigComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(BusinessConfigComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.businessConfigs?.[0]).toEqual(expect.objectContaining({ id: '123' }));
    });
