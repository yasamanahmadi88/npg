...
describe('Component Tests', () => {
  describe('OffDay Management Component', () => {
    let comp: OffDayComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(OffDayComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.offDays?.[0]).toEqual(expect.objectContaining({ id: 123 }));
    });
