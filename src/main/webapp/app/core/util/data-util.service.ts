...
export class DataUtils {
  ...
  openFile(data: string, contentType: string | null | undefined): void {
    ...
    if ((window.navigator as Navigator & { msSaveOrOpenBlob?: (blob: Blob) => void }).msSaveOrOpenBlob) {
      // To support IE
      ...
      (window.navigator as Navigator & { msSaveOrOpenBlob?: (blob: Blob) => void }).msSaveOrOpenBlob!(blob);
    } else {
      // Other browsers
