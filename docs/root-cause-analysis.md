...
| R12 | Git / PR scope | Mass CRLF→LF rewrite inflated PR to ~509 files | Equal add/delete on 464 paths; 460 byte-identical after `\r` strip | Reverted EOL-only; retained 50 files (incl. human-review package docs) |
